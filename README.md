# Голосовой ассистент Afina | Охлаждение для orange pi zero w2 | Home Assistant интеграция | Node-Red оповещения о неисправности охлаждения
...
Скоро допишу этот раздел, если будет хоть какая то активность (звёзды, вопросы, реквесты и тд) то думаю это меня ускорит, спасибо ❤️
