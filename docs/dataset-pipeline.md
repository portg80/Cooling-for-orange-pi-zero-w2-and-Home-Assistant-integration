...
Полный аудиодатасет состоит из сырых записей, подготовленных позитивных примеров, негативных фрагментов и аугментированных вариантов. Скрипты в этом разделе позволяют повторить подготовку на локальном наборе аудио и сформировать манифесты для обучения wake word модели.
